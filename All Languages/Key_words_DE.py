...
equipements = ['applianc', 'featur', 'portabl', 'satellit', 'function', 'option', 'driver-assist',
...
###------------------------------------------------------------------------###
data = pd.read_csv("intermediate/Reviews_final_DE.csv", error_bad_lines=False)
...
data_custered.to_csv("ZOE_clustered_DE.csv", header=True, index=False, index_label=False)
###-----------------------------------------------------------------------------------###


###------------------------------------------------------------------------------------------------------------------###
sent = pd.read_csv("ZOE_clustered_DE.csv", error_bad_lines=False)
...
with open("ZOE_clustered_negatives_DE.csv", 'w+', encoding="utf-8") as file:
...
###-----------------------------------------###
Plot_Clusters_trained("ZOE_clustered_DE.csv", "")
Plot_Time_Series("ZOE_clustered_DE.csv")
wordcloud_cluster_byIds("ZOE_clustered_DE.csv")
###-----------------------------------------###
